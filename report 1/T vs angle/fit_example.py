...
def quadratic(t, a, b, c):
    return a*t**2 + b*t + c
def quadratic1(t, a, b, c):

    return c*(a*t**2 + b*t + 1)
...
xlabel = "Angle (rad)"
ylabel = "Period(s)"
title="Relation between Period and amplitude"

# Now we make the plot, displayed on screen and saved in the directory, and print the best fit values
bb.plot_fit(quadratic1, x, y, xerr, yerr, init_guess=init_guess, font_size=font_size,
